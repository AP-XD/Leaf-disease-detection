...
def testmodel(filename):
    ...
    selected_model = '5-conv-128-nodes-2-dense-1583918748.h5'
    files = os.listdir('./uploads')
    if (filename):
    ...
    for model in models:
        ...
        if (setData):
            ...
            print("Highest validation accuracy: " +
                  str(setData['highest_validation_acc']))
            print("Lowest validation loss: " +
                  str(setData['lowest_validation_loss']))
            print(" ")
            print("Model Summary")
            print("--------------")
            print("Model description: " +
                  setData['model_profile']['model_desc_name'])
            print("No. of non trainable params: " +
                  setData['model_profile']['non_trainable_params'])
            print("No. of trainable params: " +
                  setData['model_profile']['trainable_params'])
